...
To get a eZ Cash merchant account visit their website by clicking [here](http://www.ezcash.lk)
...
= Contribute =
To contribute to this plugin feel free to fork it on GitHub [Dialog eZ Cash Payment Gateway for WooCommerce on GitHub](https://github.com/madurapa/woocommerce-ezcash)
...
__*You can select the radio button next to eZ Cash from the list of payment gateways available to make it the default gateway.*__
